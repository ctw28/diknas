...
<html lang="en">
    <head>
        ...
        <meta charset="utf-8" />
        <title>Penilaian Pengetahuan</title>
                ...
                <div class="main-content-inner">
                    <div class="breadcrumbs ace-save-state" id="breadcrumbs">
                        <ul class="breadcrumb">
                            ...
                            <li><a href="http://localhost/proses_belajar/index.php/pengetahuan">Penilaian</a></li>
...
<h3 class="header smaller lighter blue">Penilaian Pengetahuan</h3>
            ...
            <thead>
                ...
                <tbody>
                    ...
                    <tr> 
                        ...
                        <td width="5%"><input type="number" id="<?php echo $row->no_induk ?>kd1" readonly="" value="0"></td>
                        <td width="5%"><input type="number" id="<?php echo $row->no_induk ?>kd2" readonly="" value="0"></td>
                        <td width="5%"><input type="number" id="<?php echo $row->no_induk ?>kd3" readonly="" value="0"></td>
                        <td width="5%"><input type="number" id="<?php echo $row->no_induk ?>kd4" readonly="" value="0"></td>
                        <td width="5%"><input type="number" id="<?php echo $row->no_induk ?>kd5" readonly="" value="0"></td>
                        <td width="5%"><input type="number" id="<?php echo $row->no_induk ?>rerata" readonly="" value="0"></td>
                        <td width="5%"><input type="number" id="<?php echo $row->no_induk ?>uas" value="0"></td>
                        <td width="5%"><input type="number" id="<?php echo $row->no_induk ?>uts" value="0"></td>
                        <td ><input type="number" id="<?php echo $row->no_induk ?>nilaipengetahuan" readonly="" value="0"></td>
                        <td><span id="<?php echo $row->no_induk ?>predikat" class="label label-sm label-success"> A </span></td>
                        <td><span id="<?php echo $row->no_induk ?>predikat" class="label label-sm label-success"> LULUS </span></td>
                    </tr>
                    <?php 
                        }
                    ?>
                    <!-- <form action="pengetahuan/edit/<?php echo $row->id_pengetahuan?>" method="post" > -->
                        ...
                        <tr class="<?php echo $row->no_induk ?>" style="display: none;"> 
                            ...
                            <td><input type="number" name="kd1" id="<?php echo $row->no_induk ?>kd1_<?php echo $i; ?>" value="<?php echo $row->kd1 ?>"></td>
                            <td><input type="number" name="kd2" id="<?php echo $row->no_induk ?>kd2_<?php echo $i; ?>" value="<?php echo $row->kd2 ?>"></td>
                            <td><input type="number" name="kd3" id="<?php echo $row->no_induk ?>kd3_<?php echo $i; ?>" value="<?php echo $row->kd3 ?>"></td>
                            <td><input type="number" name="kd4" id="<?php echo $row->no_induk ?>kd4_<?php echo $i; ?>" value="<?php echo $row->kd4 ?>"></td>
                            <td><input type="number" name="kd5" id="<?php echo $row->no_induk ?>kd5_<?php echo $i; ?>" value="<?php echo $row->kd5 ?>"></td>
                            <td>
