                            ...
                            <?php echo form_open_multipart('pengaturan/update_siswa', 'class="form-horizontal"', 'role="form"'); ?>
                                ...
                                <input type="hidden" name="id_siswa" value="<?php echo $id_siswa ?>">
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="no_induk" placeholder="no induk" class="col-xs-10 col-sm-5" value="<?php echo $no_induk ?>"/>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-9">
                                            <input type="text" name="nama_siswa" placeholder="nama siswa" class="col-xs-10 col-sm-5" value="<?php echo $nama_siswa ?>" />
                                        </div>
                                    </div>
